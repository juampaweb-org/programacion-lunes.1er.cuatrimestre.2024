...
"""
coeficienteA = float(input("Ingrese el numero correspondiente al coeficiente A: "))
coeficienteB = float(input("Ingrese el numero correspondiente al coeficiente B: "))
...
if coeficienteA == 0 and coeficienteB == 0:
    ...
    print("La ecuación tiene una solución: ", resultado)
